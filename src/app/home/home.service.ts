...
export class HomeService {
  actionEvent: Subject<string> = new Subject();
  currentTaskEvent: Subject<Task> = new Subject();
  currentMilestoneEvent: Subject<Milestone> = new Subject();
  ...
  mockTasks: Task[] = [
    {
      ...
      milestone: this.mockMilestones[1],
      team: this.mockTeam,
      required: true,
    },
    {
